...
window.I18N = {
  es: {
    ...
    cookiesPage: {
      ...
      responsibleText: "El responsable del tratamiento de los datos es Sergi Sagrera (sergisagrera.com). Para cualquier consulta puedes escribir a hola@sergisagrera.com.",
      transfer: "Al aceptar la analítica, Google LLC puede tratar datos fuera del Espacio Económico Europeo, amparándose en el marco de adecuación de datos UE–EE. UU. vigente.",
  ...
  ca: {
    ...
    cookiesPage: {
      ...
      responsibleTitle: "Responsable",
      responsibleText: "El responsable del tractament de les dades és Sergi Sagrera (sergisagrera.com). Per a qualsevol consulta pots escriure a hola@sergisagrera.com.",
      transfer: "En acceptar l'analítica, Google LLC pot tractar dades fora de l'Espai Econòmic Europeu, emparant-se en el marc d'adequació de dades UE–EUA vigent.",
  ...
  en: {
    ...
    cookiesPage: {
      ...
      responsibleText: "The data controller is Sergi Sagrera (sergisagrera.com). For any query, write to hola@sergisagrera.com.",
      transfer: "When you accept analytics, Google LLC may process data outside the European Economic Area under the current EU–US data adequacy framework.",
